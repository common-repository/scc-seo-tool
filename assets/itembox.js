...
jQuery(document).ready(function($) {
    $(document).delegate(".item-list-container .item-list .generate-key", "click", function (event ) {
            var secret_key = MD5(Math.random() + "");
            $(this).parent().find(".secret_key").val(secret_key);
